          ...
          <form wire:submit.prevent="contactFormSubmit" action="/contact" method="POST" class="w-full">
            ...
            <div class="pb-3">
              ...
              <input wire:model="email"
                class="w-full px-5 py-3 border border-gray-400 rounded-lg outline-none focus:shadow-outline" type="text"
            ...
            <div class="py-3">
              ...
              <textarea wire:model="comment" row="4"
                ...
                name="comment" placeholder="Your message here...">{{ old('comment') }}</textarea>
            </div>
            <div class="pt-3">
              <button
